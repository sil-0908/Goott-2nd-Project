...
<div class="container_j"> 
	<div class="background_j">
		...
		<div id="mainDiv_j">
	        <div id="viewDiv_j">
				<span id="signUpText_j">LOGO join the membership</span>
		            <!-- form start  -->
					<form name="form1" action="signup" method="post">
		                <div id="viewInput_j">
							...
							<div class="wrapInput">
								...
								<div>
					            	<button type="button" id="btn"> ID duplicate check</button>
		                	...
		                	<div class="wrapInput">	
								...
								<button type="button" id="email_btn">Email duplicate check</button>						
							...
							<div>
			                	...
			                	<button class="email_checkbtn" id="emailchk">Email Authentication</button> <!-- 이메일 인증 버튼 -->
							</div>
			               
							<!-- 비밀번호  -->
							<div id = "passwordArea">
								<div class="wrapInput">		                    	
		                    		<input type="password" name="password" id="password" placeholder="8 to 15 digits of English, numbers and special characters (~!@#$%^&*) combination" autocomplete="on">
									<i class="fa-solid fa-eye-slash fa-lg" id="eye1"></i>
									<span id="pwMsg"></span>
			                    </div>
			                    
			                    <div class="wrapInput">
			                        <input type="password" name="password1" id="password1" placeholder="Confirm Password" autocomplete="on">
		                    ...
		                    <div class="wrapInput">
		                        <input type="text" name="phone_num" id="phone_numcheck" class="formInputs" placeholder="phone number"  oninput="autoHyphen(this)" maxlength="13" autocomplete="no">
		                    </div>
		             </div>
